...
Screen recording (from compile to boot):
...
Test Success: Actual result matches the expected result.

Test Failure: Actual result does not match the expected result.
