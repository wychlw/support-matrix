...
- Download Link: [Link to Download](https://github.com/Fishwaldo/sophgo-sg200x-debian/releases/tag/v1.1.0)
- Installation Reference Document: [Installation Guide](https://github.com/Fishwaldo/sophgo-sg200x-debian)
...
- One microSD card
- One USB card reader
- One USB to UART debugger (such as: CP2102, FT2232, etc., note: do not use CH340/341 series, it will display garbled characters)
- Three DuPont wires

## Installation Steps

### Write the Image to microSD Card Using `dd`
...
The system boots normally and can be accessed via the onboard serial port.

## Actual Results

The system boots normally and access through the onboard serial port is successful.
